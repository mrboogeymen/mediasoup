...
const listenIp = process.env.MEDIASOUP_ANNOUNCED_IP || "192.168.1.13";
const remoteIp = process.env.MEDIASOUP_REMOTE_IP || "192.168.1.68";
...
(async function() {
  ...
  console.log('local ', room.pipeTransport.tuple.localIp, ':', room.pipeTransport.tuple.localPort);
